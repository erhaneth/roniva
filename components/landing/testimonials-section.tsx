      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 grid gap-4 lg:grid-cols-3">
          {t.testimonials.items.map((item) => (
            <figure
              key={item.name}
              className="rounded-[8px] border border-black/10 bg-[#f7f7f7] p-5 transition duration-300 hover:-translate-y-1 hover:bg-white hover:shadow-2xl hover:shadow-black/[0.08]"
            >
              <Quote aria-hidden="true" className="h-5 w-5 text-black/32" />
              <blockquote className="mt-5 text-base leading-8 text-black/74">“{item.quote}”</blockquote>
